...
namespace T1.Groups
{
    public class ToyGroup : Toy
    {
        ...
        public ToyGroup(): base()
        {
            Eatables = new List<Eatable>();
        }
        
        public ToyGroup(string name, string manufacturer, GiftItemComponent initComponent) : base(name,
            manufacturer, initComponent)
        {
            Eatables = new List<Eatable>();
        }

        public ToyGroup(string name, string manufacturer, Eatable eatable, int sweetCount) : base(name,
            manufacturer)
        {
            Eatables = new List<Eatable>();
